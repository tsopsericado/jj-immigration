      ...
      <div className="mt-8 py-6 border-t items-center justify-between sm:flex">
        ...
        <div className="mt-6 sm:mt-0">
          <ul className="flex items-center space-x-4">
            <li className="w-10 h-10 border rounded-full border-primary-color flex items-center justify-center">
            ...
            <li className="w-10 h-10 border rounded-full border-primary-color flex items-center justify-center">
              <Link href="https://www.facebook.com/profile.php?id=61557544078696&mibextid=ZbWKwL&_rdc=2&_rdr">
                <svg
                  className="svg-icon hover:cursor-pointer w-6 h-6 text-blue-700"
                  viewBox="0 0 20 20"
                >
                  <path
                    fill="none"
            ...
            <li className="w-10 h-10 border rounded-full border-primary-color flex items-center justify-center">
              <Link href="javascript:void()">
                <svg
                  className="svg-icon w-6 h-6 hover:cursor-pointer text-blue-500"
                  viewBox="0 0 20 20"
                >
                  <path
                    fill="none"
